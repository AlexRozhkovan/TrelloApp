...
import static spd.trello.controller.EntityBuilder.buildCheckList;

@ExtendWith(MockitoExtension.class)
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.MOCK, classes = TrelloApplication.class)
...
public class CardControllerTest extends AbstractControllerTest<Card> {
    ...
    public void failUpdate() throws Exception {
        ...
        assertAll(
                () -> assertEquals(HttpStatus.BAD_REQUEST.value(), result.getResponse().getStatus()),
                () -> assertEquals("Card can't be updated because it archived", result.getResponse().getContentAsString())
        );
    }
